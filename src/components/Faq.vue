...
const questions = [
	{
		...
		answer:
			'Стоимость зависит от сложности и объёма проекта. Лендинг начинается от 30 000 ₽, многостраничный сайт — от 60 000 ₽, веб-приложение — от 100 000 ₽. Точную цену называем после обсуждения задачи — напишите нам, и мы подготовим расчёт.'
	},
	{
		num: '02.',
		question: 'Сроки?',
